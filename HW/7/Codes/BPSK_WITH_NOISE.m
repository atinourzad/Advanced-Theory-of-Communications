...
for k = 0:20
    ...
    for i=1:12
        ...
        elseif i==2
            cCalc1 = c([1;2], i-1) + real( I(1)' * ( 2*y(i)-(5/6)*I(1)-I(foundPath) ) );
            [c(1,i), maxIndex1] = max(cCalc1);

            cCalc2 = c([1;2], i-1) + real( I(2)' * ( 2*y(i)-(5/6)*I(2)-I(foundPath) ) );
            ...
            cCalc1 = c([1;2], i-1) + real( I(1)' * ( 2*y(i)-(5/6)*I(1)-I(foundPath(:,i-1))-(1/6)*I(foundPath(:,i-2)) ) );
            [c(1,i), maxIndex1] = max(cCalc1);

            cCalc2 = c([1;2], i-1) + real( I(2)' * ( 2*y(i)-(5/6)*I(2)-I(foundPath(:,i-1))-(1/6)*I(foundPath(:,i-2)) ) );
            [c(2,i), maxIndex2] = max(cCalc2);
...
xlabel('SNR (dB)');
ylabel('p_e');
title('Probability of Error for Detectiong BPSK Noisy Bits Using Viterbi Algorithm');
